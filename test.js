...
// Не буду приводить примеры стандартных, всеми применяемых циклов, таких как for, while, do...while, а остановлюсь на методах
// for...in, for...of, forEach. Оба этих цикла примпняются как к массивам, так и к объектам и строкам:
...
//                                          ПРИМЕНЯЕТСЯ ДЛЯ ПЕРЕБОРА ЗНАЧЕНИЙ МАССИВА(!!!) КАК И В for of, 
//                                          не является функцией-методом и не может возвращать какое-либо отдельное значение.
//                                          То есть будет выводить все значения итерируемого объекта, и если мы захотим создать
//                                          условие, например, break на каком-либо значении, редактор выдаст ошибку!


// const str = ['r', 'u', 'b', 'i', 'k', 'o', 'n'];
